...
const replacements = [
  {
    id: "b014",
    regex: /(## Knauf vs Rigips — dwie marki, jeden standard EN 520\n\n)/,
  ...
  {
    id: "b015",
    regex: /(## Jaki klej do styropianu wybrać\? Rodzaje i zastosowanie\n\n)/,
  ...
  {
    id: "b017",
    regex: /(## Jak obliczyć ilość tynku na elewację\? Kalkulator i normy zużycia\n\n)/,
  ...
  {
    id: "b019",
    regex: /(## Cennik materiałów izolacyjnych 2026 — styropian i wełna\n\n)/,
