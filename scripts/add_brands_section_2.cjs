...
const targetString = `                {/* ⚡ Banner Two-Phase: widoczny podczas ładowania reszty produktów w tle */}`;
const brandsSection = `
...
if (content.includes(targetString) && !content.includes('Popularne marki w tej kategorii (Wizualny Silos)')) {
