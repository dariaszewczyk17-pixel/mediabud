...
async function check() {
  const cats = await client.fetch(`*[_type == "category" && slug.current in ["worki-na-gruz-i-smieci", "narzedzia-i-mocowania", "odkurzacze-worki-rury"]]{
    name, "slug": slug.current, _id
  }`);
