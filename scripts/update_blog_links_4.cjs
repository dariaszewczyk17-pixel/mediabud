...
const replacements = [
  {
    id: "b013",
    regex: /(## Koszt materiałów izolacyjnych\n\n)/,
    replace: "$1Aby precyzyjnie wyliczyć zapotrzebowanie na materiał, skorzystaj z naszego [kalkulatora styropianu i wełny](/kalkulator/styropian-welna).\n\n"
  },
  {
    id: "b014",
    regex: /(## Płyty gipsowo-kartonowe\n\n)/,
  ...
  {
    id: "b015",
    regex: /(## Rodzaje klejów do styropianu\n\n)/,
  ...
  {
    id: "b019",
    regex: /(## Ceny styropianu fasadowego\n\n)/,
