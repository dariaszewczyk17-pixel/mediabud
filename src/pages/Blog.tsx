  ...
  return (
    <div className="min-h-screen" style={{ background: "#080808" }}>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* ── Filtr kategorii ── */}
        <div className="flex flex-wrap items-center gap-2 mb-8 pb-6" style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          ...
          {categories.map(cat => (
            <button
              ...
              style={{
                background: activeCategory === cat ? "#f81828" : "rgba(255,255,255,0.05)",
                color: activeCategory === cat ? "#fff" : "#888",
                border: `1px solid ${activeCategory === cat ? "#f81828" : "rgba(255,255,255,0.1)"}`,
                boxShadow: activeCategory === cat ? "0 0 12px rgba(248,24,40,0.3)" : "none",
              }}
            >
              {cat}
              {cat !== "Wszystkie" && (
          ...
          <span className="ml-auto text-[10px] text-gray-600">{filtered.length} artykuł{filtered.length === 1 ? "" : filtered.length < 5 ? "y" : "ów"}</span>
        </div>
        ...
        {featured && (
          <Link
            ...
            className="group block mb-8 rounded-2xl overflow-hidden transition-all duration-300"
